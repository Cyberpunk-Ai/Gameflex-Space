...
import {
  Bell, Trophy, CreditCard, Gamepad2, Info, MessageSquare,
  CheckCheck, Heart, UserPlus, Star, Zap, Shield, AlertCircle,
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className={cn('text-[13.5px] leading-snug', !notif.is_read ? 'font-semibold text-foreground' : 'font-medium text-foreground/90')}>
          {notif.title}
        </p>
        {notif.message && (
  ...
  const guestCta = (
    <div className="flex flex-col items-center justify-center py-20 gap-5">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1 mb-5">Likes, follows, rewards and more — all in one place.</p>
