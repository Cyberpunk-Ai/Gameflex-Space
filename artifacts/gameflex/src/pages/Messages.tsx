    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4">
        <div className="max-w-sm w-full text-center rounded-2xl border border-border/50 bg-card/60 backdrop-blur-md p-8 shadow-sm">
          ...
          <p className="text-muted-foreground text-sm mb-5">Chat with your squad and other GameFlex players securely.</p>
    ...
    <div className="flex h-[calc(100dvh)] overflow-hidden bg-gradient-to-b from-background via-background to-secondary/20">
      ...
      <div
        className={cn(
          ...
          showMobileChat && "md:translate-x-0 -translate-x-full md:flex absolute md:relative inset-y-0 left-0 z-10",
      ...
      <div
        className={cn(
          ...
          !showMobileChat && "md:translate-x-0 translate-x-full md:flex absolute md:relative inset-y-0 right-0",
          showMobileChat && "translate-x-0 flex"
        )}
      >
        {selectedConversationId && selectedUser ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 animate-fade-in">
            ...
            >
              ...
              <span
                className="absolute inset-0 rounded-3xl ring-1 ring-inset ring-white/20 pointer-events-none"
              />
            </div>
