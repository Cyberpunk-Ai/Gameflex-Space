...
export const STORY_GRADIENTS: StoryGradient[] = [
  ...
  { id: "ember", label: "Ember", css: "linear-gradient(135deg, hsl(25 100% 55%) 0%, hsl(0 84% 60%) 100%)" },
  { id: "aurora", label: "Aurora", css: "linear-gradient(135deg, hsl(280 80% 55%) 0%, hsl(142 76% 45%) 100%)" },
  { id: "arcade", label: "Arcade", css: "linear-gradient(135deg, hsl(280 100% 60%) 0%, hsl(330 100% 60%) 100%)" },
  { id: "frost", label: "Frost", css: "linear-gradient(135deg, hsl(200 100% 50%) 0%, hsl(190 90% 70%) 100%)" },
  { id: "carbon", label: "Carbon", css: "linear-gradient(135deg, hsl(220 15% 18%) 0%, hsl(220 12% 32%) 100%)" },
];
...
export function isVideoStory(story: { media_type?: string | null; media_url?: string | null }): boolean {
