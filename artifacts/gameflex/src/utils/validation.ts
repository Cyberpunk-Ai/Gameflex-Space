...
export function isValidPhone(phone: string): boolean {
  const phoneRegex = /^(?:254|\+254|0)?(7(?:(?:[129][0-9])|(?:0[0-8])|(?:4[0-35689])|(?:5[7-9])|(?:6[89])|(?:8[0-25-9])|(?:3[0-9]))[0-9]{6})$/;
...
export function validateTournamentInput(data: Record<string, unknown>): { valid: boolean; errors: Record<string, string> } {
  ...
  if (typeof data.entry_fee !== 'number' || data.entry_fee < 0) errors.entry_fee = 'Valid entry fee is required';
