    ...
    ' hover-elevate active-elevate-2',
  {
    variants: {
      variant: {
        ...
        neon:
          'border border-primary/60 bg-primary/10 text-primary font-semibold hover:bg-primary/20 hover:border-primary shadow-[0_0_12px_rgba(34,197,94,0.2)] hover:shadow-neon active:scale-[0.98] no-default-hover-elevate no-default-active-elevate',
        // Success / warning / danger aliases
        success:
          'bg-green-600 text-white hover:bg-green-700 border border-green-700',
        warning:
          'bg-yellow-500 text-black hover:bg-yellow-600 border border-yellow-600',
        danger:
