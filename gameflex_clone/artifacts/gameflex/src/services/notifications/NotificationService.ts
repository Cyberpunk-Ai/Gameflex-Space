...
export class NotificationService {
  ...
  async send(type: 'inapp' | 'push' | 'email' | 'sms', notification: NotificationPayload): Promise<void> {
  ...
  async sendToUser(userId: string, notification: Omit<NotificationPayload, 'userId'>, channels: ('inapp' | 'push' | 'email' | 'sms')[] = ['inapp']): Promise<void> {
