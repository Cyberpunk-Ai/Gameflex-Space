...
export const TOURNAMENT_STATUSES = ['upcoming', 'registration_open', 'registration_closed', 'live', 'completed', 'cancelled'] as const;
...
export const LISTING_CATEGORIES = ['skins', 'accounts', 'items', 'currency', 'services', 'other'] as const;
